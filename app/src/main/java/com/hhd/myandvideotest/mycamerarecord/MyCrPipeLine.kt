...
class MyCrPipeLine {
    ...
    constructor() {
        _pipeline
            ...
            .observeOn(MyUtil.newNamedScheduler("T_ENCODER_START_DRAIN"))
            .map {
                val paramArray = it as Array<*>
                val cmd = paramArray[0] as _Commands
            ...
            .observeOn(MyUtil.newNamedScheduler("T_ENCODER_WRITE"))
            .map {
                val paramArray = it as Array<*>
                val cmd = paramArray[0] as _Commands
                ...
                when (cmd) {
                    _Commands.WRITE_TO_FILE -> {
                        ...
                        val bufParrArray =
                            paramArray[1] as MutableList<Pair<ByteBuffer, MediaCodec.BufferInfo>>
